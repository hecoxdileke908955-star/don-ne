        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm text-text-muted">
              {config?.brandName ?? 'Dọn Nè'} phục vụ trực tiếp trên địa bàn Hà Nội, đội thi công có mặt nhanh chóng tại các quận huyện dưới đây.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {DISTRICTS.map((district) => (
              <div key={district} className="flex flex-col rounded-[20px] border border-gray-200 bg-white p-5 shadow-sm">
                <span className="mb-2 inline-block w-fit rounded-full bg-primary-soft px-3 py-1 text-[11px] font-bold text-primary">Quận/Huyện</span>
                <h3 className="text-sm font-bold text-text-main">{district}</h3>
